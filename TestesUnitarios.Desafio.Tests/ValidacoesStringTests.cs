...
public class ValidacoesStringTests
{
    ...
    [Fact]
    public void DeveRetornar6QuantidadeCaracteresDaPalavraMatrix() //retorna quantidade de caracteres de uma string
    {
    ...
    [Fact]
    public void DeveContemAPalavraQualquerNoTexto()//procura uma sequencia específica de caracteres no texto
    {
        // Arrange
    ...
    [Fact]
    public void NaoDeveConterAPalavraTesteNoTexto()//done
    {
        // Arrange
        var texto = "Esse é um texto qualquer";
